...
public class DiseaseModel {
	...
	public DiseaseModel(int disc_id, String disc_name, String disc_icdcode, String disc_desc, String disc_status) {
		super();
	...
	public String toString() {
		return "DiseaseModel [disc_id=" + disc_id + ", disc_name=" + disc_name + ", disc_icdcode=" + disc_icdcode
